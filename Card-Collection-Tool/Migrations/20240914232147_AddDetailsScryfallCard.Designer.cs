...
namespace Card_Collection_Tool.Migrations
{
    ...
    [Migration("20240914232147_AddDetailsScryfallCard")]
    partial class AddDetailsScryfallCard
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ScryfallCard", b =>
                {
                    ...
                    b.OwnsOne("Legalities", "Legalities", b1 =>
                        {
                            b1.Property<string>("ScryfallCardId")
                                .HasColumnType("nvarchar(450)");

                            b1.Property<string>("Banned")
                                .HasColumnType("nvarchar(max)")
                                .HasAnnotation("Relational:JsonPropertyName", "banned");

                            b1.Property<string>("Legal")
                                .HasColumnType("nvarchar(max)")
                                .HasAnnotation("Relational:JsonPropertyName", "legal");

                            b1.Property<string>("NotLegal")
                                .HasColumnType("nvarchar(max)")
                                .HasAnnotation("Relational:JsonPropertyName", "not_legal");

                            b1.Property<string>("Restricted")
                                .HasColumnType("nvarchar(max)")
                                .HasAnnotation("Relational:JsonPropertyName", "restricted");

                            b1.HasKey("ScryfallCardId");

                            b1.ToTable("ScryfallCards");

                            b1.HasAnnotation("Relational:JsonPropertyName", "legalities");
